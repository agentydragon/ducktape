{
  ...
  inputs = {
    ...
    ducktape-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/ducktape-30de02e4/ducktape-0.1.0-py3-none-any.whl";
      flake = false;
    };
    claude-hooks-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/claude-hooks-fab8e4c1/claude_hooks-0.1.0-py3-none-any.whl";
      flake = false;
    };
    headscale-cleanup-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/headscale-cleanup-30de02e4/headscale_cleanup-0.1.0-py3-none-any.whl";
      flake = false;
    };
    gterm-theme-wheel = {
      url = "https://github.com/agentydragon/ducktape/releases/download/gterm-theme-30de02e4/gterm_theme-0.1.0-py3-none-any.whl";
      flake = false;
    };
