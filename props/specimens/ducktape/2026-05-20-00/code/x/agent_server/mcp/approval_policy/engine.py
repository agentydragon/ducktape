...
from x.agent_server.approvals import ApprovalRequest, ApprovalToolCall
from x.agent_server.models.proposal_status import ProposalStatus
from x.agent_server.persist.types import ApprovalOutcome, Persistence
...
from x.agent_server.policy_eval.runner import run_policy_source
...
def _load_instructions(policy_uri: str) -> str:
    """Load and render instructions with embedded shared constants via Mako.
    ...
    result: str = tmpl.render(
        RUNTIME_MOUNT_PREFIX=ContainerExecServer.RUNTIME_MOUNT_PREFIX,
