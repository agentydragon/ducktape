...
from x.agent_server.mcp.approval_policy.engine import PolicyEngine, PolicyReaderServer
from x.agent_server.presets import create_agent_from_preset, discover_presets
...
approval_policy: |
    # Custom policy
    from x.agent_server.policies.policy_types import PolicyRequest, PolicyResponse, ApprovalDecision
    from x.agent_server.policies.scaffold import run
