...
from x.agent_server.policies.policy_types import ApprovalDecision
from x.agent_server.testing.fixtures import make_policy_request


def _make_policy_for_decision(decision_enum: str) -> str:
    return (
        "from x.agent_server.policies.policy_types import ApprovalDecision, PolicyRequest\n"
