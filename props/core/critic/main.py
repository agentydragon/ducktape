...
from agent_core.handler import AbortIf, LoggingHandler, RedirectOnTextMessageHandler
...
def main() -> int:
    ...
    system_prompt = render_system_prompt(
        template_path="props/docs/agents/critic.md.j2",
        helpers={"scope_description": get_scope_description()},
        env_var="PROMPT_TEMPLATE_PATH",
    )
