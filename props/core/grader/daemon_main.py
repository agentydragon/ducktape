...
from props.core.agent_template import WORKSPACE, render_system_prompt, setup_logging
from props.core.db.config import get_database_config
from props.core.db.session import get_session
from props.core.grader.loop import GraderMode, check_grading_pending, run_grader_loop
...
async def run_daemon(snapshot_slug: SnapshotSlug, system_prompt: str, model: str) -> int:
...
async def main() -> int:
    ...
    exit_code = await run_daemon(snapshot_slug, system_prompt, model)
