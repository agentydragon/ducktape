...
from props.core.grader.loop import GraderDriftHandler, check_grading_pending
...
class GraderDaemonScaffold:
    ...
    def _notification_callback(
        ...
        logger.debug(
            f"Notification for {self._snapshot_slug}: {notification.event.operation} {notification.event.table}"
        )
