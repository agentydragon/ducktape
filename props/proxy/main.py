"""CLI entrypoint for combined proxy service."""
...
cli = typer.Typer(help="Combined LLM and Registry proxy service")


@cli.command()
def serve(
    host: Annotated[str, typer.Option(help="Host to bind to")] = "0.0.0.0",
    port: Annotated[int, typer.Option(help="Port to bind to")] = 5050,
