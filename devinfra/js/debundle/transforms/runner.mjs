...
import { formatDuration, logProgress, relativeWorkspacePath, resolveWorkspacePath } from "../common/io.mjs";
import { rewriteChunkEntrySpecifiers } from "./rewrite_specifiers.mjs";
...
function parseJsonWithComments(text, sourceName = "<jsonc>") {
  try {
