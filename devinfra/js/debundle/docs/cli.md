...
| `debundle spec selector-codemod` | yes, with `--apply` | Dry-run by default; emits text/json/ndjson summary rows for mechanical selector rewrites. The default rewrite (`--rewrite single-target-binding`) scans member-form `selector.source_match` entries and adds `target_binding` when the selector source declares exactly one top-level binding. Use `--file`, `--module`, or `--module-prefix` to scope the run before applying. Skipped rows include a machine-readable reason.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
