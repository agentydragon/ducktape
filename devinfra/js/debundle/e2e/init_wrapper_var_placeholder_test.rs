...
//! and reads as `undefined` — semantically harmless because the
//! init function will set the value before any consumer can act on
//! the read.
//!
...
"#,
    ...
    // `a` is the simplest binding — pin its placeholder shape. The
