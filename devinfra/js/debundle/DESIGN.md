...
| 1.6.4 | Migrate emit-side helpers (`cross_module_imports_for_body`, `source_chunk_imports_for_moved_body`, `init_dep_names_for_body`) to `&Schedule` | Pending; pairs with Phase 3 (init-wrapper deletion lands in the same surface)                                     |
| 1.6.5 | Migrate closure pass to `&Schedule` with cycle-aware refusal                                                                                 | Pending                                                                                                           |
