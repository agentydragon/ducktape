...
- **Selector debt reporting.** Shipped as `debundle spec selector-debt`:
  ...
  statement today but have high-scoring non-matching sibling statements.
  Remaining work: rank multi-statement windows, consider owner-graph context
  where useful, and produce richer edit-distance diagnostics than the current
