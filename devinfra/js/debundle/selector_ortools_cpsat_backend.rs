...
use selector_constraint_backend::{
    AllDifferentReason, ConstraintVariableId, PresolveScope, TargetBindingProjection,
    constraint_targets, targets_by_variable,
};
use selector_constraint_backend::{
...
mod tests {
    ...
    fn problem_summary_reports_request_shape_and_domain_diagnostics() {
        let problem = CompiledSelectorProblem {
            ...
            known_unsat: None,
            presolve_scope: PresolveScope::AcrossTargets,
        };
