...
`copilot-setup-steps.yml` configures the environment for GitHub Copilot coding agent. Sets up Python 3.14, Bazelisk, Bazel cache, pre-commit, and cluster tools (opentofu, tflint).
