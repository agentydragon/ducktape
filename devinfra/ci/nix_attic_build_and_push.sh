#!/usr/bin/env bash
# Build one destination's Nix flake outputs and push its closure to Attic.
#
...
# reaching the cache. nix-fast-build evaluates the selected ci-attic-* output in parallel
