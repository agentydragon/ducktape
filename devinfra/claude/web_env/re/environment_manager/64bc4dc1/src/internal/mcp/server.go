...
func (s *BaseServer) Stop() bool {
	...
	// Binary (a6f96673, BaseServer.Stop at 0x8c6e7d-0x8c6e98):
	// After httpServer.Shutdown, the code checks s.streamableServer (offset 0x38)
	// for non-nil. If present, it loads the vtable at s.streamableServer.itab (offset
