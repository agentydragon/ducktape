...
// Reconstructed for binary 495ea204.
//
// NOTE: Binary 495ea204 is garble-obfuscated (no DWARF, no symbol table).
// Binary addresses in this file are from the a6f96673 predecessor and are
// meaningless for the garble-obfuscated 495ea204 binary. Structure and
// behavior are inferred from runtime output and string analysis only.
//
// Key changes in 495ea204 vs a6f96673:
