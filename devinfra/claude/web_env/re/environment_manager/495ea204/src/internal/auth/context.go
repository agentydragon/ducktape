...
// CLEANUP(2026-03-26): supabaseConfig and antspaceDeployConfig removed in 495ea204.
...
//
// Binary struct layout (495ea204, garble-obfuscated):
//
// Removed in 495ea204 (vs a6f96673): vercelDeployToken, antspaceControlPlaneURL,
// antspaceAuthToken, supabaseProjectRef, supabaseAnonKey, supabaseDBPass, supabasePAT.
//
// Added in 495ea204: jwt (json:"jwt" found in binary string table).
//
...
//	offset 0x30: jwt string (ptr+len)                     ← added in 495ea204
...
type AuthContext struct {
	...
	jwt                 string // Binary: json:"jwt" tag found in 495ea204 string table.
	sessionID           string
	logger              *slog.Logger
}
...
func NewAuthContextWithSessionID(
	...
	for _, config := range configs {
		...
		case "jwt":
			// Binary: json:"jwt" tag found in 495ea204 string table.
			// New auth type added in 495ea204, replacing Vercel/Antspace/Supabase.
			if config.Token == "" {
...
// Binary: json:"jwt" tag found in 495ea204. Added in 495ea204, replacing
