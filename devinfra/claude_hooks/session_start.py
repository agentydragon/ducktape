...
from devinfra.claude_hooks.settings import CONFIG_FILES, HookSettings
from devinfra.claude_hooks.supervisor import setup as supervisor_setup
from devinfra.claude_hooks.tracing import init_tracing, shutdown_tracing
...
def setup_logging(settings: HookSettings, *, print_banner: bool = True) -> tuple[LogCollector, Path]:
    """Configure root logger so all modules in devinfra.claude_hooks get handlers.
