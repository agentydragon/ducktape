...
- FastMCP still provides no verified-principal hook or post-IdP interaction; P1 contains verification in Haku, while the prototype itself decodes raw upstream token material;
