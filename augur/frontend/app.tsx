...
function ProductProjectionWorkspace({
  ...
  useEffect(() => {
    ...
    // The shell-owned shared params live outside the scenario set. Carry whichever are currently set
    // across so rewriting the product `?s=`/`?scenarios=` state doesn't drop them.
