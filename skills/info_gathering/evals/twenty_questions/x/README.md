...
| LangGraph         | Python   | `langgraph/`       | Disabled: `langchain-mcp-adapters` has no mcp-sdk >=2.0-compatible release (#5786) |
| Agent Framework   | Python   | `agent_framework/` | Implemented (migrated from AutoGen, which is in maintenance mode)                  |
| CrewAI            | Python   | `crewai/`          | Disabled: `crewai` has no mcp-sdk >=2.0-compatible release (#5786)                 |
