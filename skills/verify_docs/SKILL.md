...
1. **Discover conventions**: read root AGENTS.md, STYLE.adoc, and the root README (`README.adoc` or `README.md`) to learn this repo's doc structure, file hierarchy, and naming conventions. Don't assume — each repo may differ.
