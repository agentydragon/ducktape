...
- `//agentplane/app:test_main`: application Settings environment parsing and OIDC source coexistence.
...
- `//agentplane/action_service:test_acceptance`: exact operator arguments including nested
