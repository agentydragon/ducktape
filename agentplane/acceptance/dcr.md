...
`//agentplane/acceptance:test_dcr` starts an actual MCP Python SDK `ClientSession`
...
```bash
bazelisk test //agentplane/acceptance:test_dcr --nocache_test_results --test_output=errors
```
