...
IMAGE = OciImage("_main/agentplane/runner/image_rloc.rloc", "agentplane-runner:test")
...
@pytest.fixture
async def container(harness: protocol_pb2.Harness, endpoint: AnthropicMessages | OpenAIResponses) -> AsyncIterator[str]:
