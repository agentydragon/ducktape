...
The proxy (agentplane/egress) enforces these resources; the app reads the same objects through the
...
# The kinds themselves are `agentplane.egress.resources`, shared with the proxy that enforces them.
