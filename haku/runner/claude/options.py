...
The harness that starts and drives this process is <harness.py> `ClaudeHarness`; this module
...
`build_claude_launch` is the one place a session's argv is decided, and `test_options.py` pins
...
from haku.runner.protocol import FINE_GRAINED_TOOL_STREAMING_ENV, HarnessLaunch
