...
<../../cluster/k8s/haku/dispatch/README.md>; zone perimeters:
<../../cluster/k8s/haku/zones/README.md>.
...
`.github/workflows/haku-zone-worker-image.yml`) carries both zone harnesses — **Claude
