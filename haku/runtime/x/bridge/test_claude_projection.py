...
(`testdata/claude_diverse_session.jsonl`): every frame Claude Code 2.1.233 emitted while writing a
...
from haku.runtime.x.bridge.claude_projection import ClaudeProjector, undelivered
...
_CAPTURE = "haku/runtime/x/bridge/testdata/claude_diverse_session.jsonl"
