...
from haku.runtime.x.bridge.backend import BRIDGE_CREDENTIAL_VARIABLE, Harness
from haku.runtime.x.bridge.backend_registry import HarnessFactory, runner_harnesses
...
def parse_args(harnesses: Mapping[str, HarnessFactory]) -> argparse.Namespace:
    ...
    # example `claude_options.EXECUTABLE_VARIABLE`); this is for a local run against a CLI elsewhere.
