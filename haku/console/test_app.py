...
def test_healthz_and_index(client, seeded) -> None:
...
def test_click_records_overlay_and_renders_clicked(client, seeded) -> None:
...
def test_unclick_retracts_the_overlay(client, seeded) -> None:
    item_id = seeded.ids[0]
...
def test_delete_clears_the_click(client, seeded) -> None:
    item_id = seeded.ids[0]
    client.post(f"/items/{item_id}/actions/snooze")
