...
| `session_runtime._run_turn`, `result`                        | The frame the completion was projected from, kept because the code below still reads Claude's own payload | <../plans/conversation_layers.md> § 9 step 3                                                                    |
