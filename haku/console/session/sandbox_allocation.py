...
class SandboxAllocator:
    ...
    def __init__(self, service: SessionService, store: Store, notifications: SessionWakes, engine: AsyncEngine):
    ...
    async def allocate_once(self) -> None:
        ...
        The snapshot is advisory. ``Store.allocate`` takes the session row lock and repeats
