...
// The gmail write-tool argument types (BatchModifyGmailThreadLabelsArgs, CreateGmailDraftArgs)
...
// Live subject/snippet/current-labels lookup for rendering a threads_batch_modify
