...
// Holds the fixtures plus the mount call, with the Calendar-only MCP stub imported before the
// registry/widget graph reaches client.ts. `satisfies RegisteredToolPreviewFixture` ties each
      ...
      events: [
        {
          ...
          html_link: "https://calendar.google.com/calendar/event?eid=planning-series",
        },
        {
          ...
          html_link: "https://calendar.google.com/calendar/event?eid=quarterly-planning",
        },
      ],
      ...
      events: [
        {
          ...
          html_link: "https://calendar.google.com/calendar/event?eid=series-standup_20260720T163000Z",
        },
      ],
    },
  },
