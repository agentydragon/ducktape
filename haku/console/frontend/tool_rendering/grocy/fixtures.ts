...
export const GROCY_MCP_FIXTURES = {
  grocy_sf__products_list: (): typeof GROCY_REFERENCE_FIXTURE.products => GROCY_REFERENCE_FIXTURE.products,
  grocy_sf__locations_list: (): typeof GROCY_REFERENCE_FIXTURE.locations => GROCY_REFERENCE_FIXTURE.locations,
  grocy_sf__quantity_units_list: (): typeof GROCY_REFERENCE_FIXTURE.quantity_units =>
    GROCY_REFERENCE_FIXTURE.quantity_units,
  grocy_sf__product_groups_list: (): typeof GROCY_REFERENCE_FIXTURE.product_groups =>
    GROCY_REFERENCE_FIXTURE.product_groups,
  grocy_sf__shopping_lists_list: (): typeof GROCY_REFERENCE_FIXTURE.shopping_lists =>
    GROCY_REFERENCE_FIXTURE.shopping_lists,
  grocy_sf__shopping_list_get: (
    args: Record<string, unknown>
  ): { items: typeof GROCY_REFERENCE_FIXTURE.shopping_list_items } => ({
    items:
