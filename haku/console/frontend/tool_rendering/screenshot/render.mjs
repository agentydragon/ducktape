...
// Chromium: the BUILD wires PUPPETEER_EXECUTABLE_PATH to the hermetic @playwright_browsers build
// under RBE; fall back to the ambient Playwright browser for a local `bazel run`.
