...
class PostgresGrantRepository:
    ...
    async def list(self, *, owner_agent_id: UUID, include_terminal: bool = True) -> tuple[Grant, ...]:
    ...
    async def release(self, *, owner_agent_id: UUID, grant_id: UUID, reason: str, ended_at: datetime.datetime) -> Grant:
    ...
    async def revoke(self, *, owner_agent_id: UUID, grant_id: UUID, reason: str, ended_at: datetime.datetime) -> Grant:
        return await self._end(
            owner_agent_id=owner_agent_id,
            grant_id=grant_id,
