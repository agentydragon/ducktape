> **ARCHIVED (2026-07-17).** Historical multiseat bring-up log — superseded by
> the single-seat0 + remote design in `../README.md`. Kept for the reasoning trail
> (why multiseat under GDM is impossible here). Sibling live files moved to `../`.
