{
  title: 'Agent iteration and run_phase logic issues',
  severity: 'medium',
  ...
  locations: [
    {
      ...
      lines: [245, 249],
      context: 'Iteration over known_agents() catches KeyError - poorly designed',
    },
    {
      path: 'adgn/src/adgn/agent/mcp_bridge/server.py',
      lines: [264, 267],
      context: 'Confusing "elif live:" inside "if infra:" block',
    },
    {
      path: 'adgn/src/adgn/agent/mcp_bridge/server.py',
      lines: [255, 315],
      context: 'Duplicated run_phase determination logic',
    },
  ],
  description: |||
