{
  title: 'Remove unnecessary and outdated comments',
  severity: 'minor',
  ...
  locations: [
    {
      ...
      lines: [40, 45],
      context: 'Comments about "now an MCP server" and redundant mount logs',
    },
    {
      path: 'adgn/src/adgn/agent/mcp_bridge/server.py',
      lines: [209, 237, 361, 363, 421, 441, 443],
      context: 'Useless "Notify that..." and other obvious comments',
    },
    {
      path: 'adgn/src/adgn/agent/mcp_bridge/server.py',
      lines: [416],
      context: 'Confusing comment about UI token authentication',
    },
    {
      path: 'adgn/src/adgn/agent/mcp_bridge/server.py',
      lines: [429, 431, 459],
      context: 'Unnecessary comments stating the obvious',
    },
  ],
  description: |||
