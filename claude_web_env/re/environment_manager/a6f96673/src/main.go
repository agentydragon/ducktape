...
//   - main.main now copies Version into internal/util.Version (line 21)
//   - code-sign command is inlined directly in main.go (lines 43/cmd_code_sign.go:112-125)
//     rather than using a separate AddCodeSignCommand function
//   - print-sandbox-settings also inlined (lines 44/cmd_print_sandbox_settings.go:15-35)
//   - Completion subcommand comes from Cobra's built-in completion generation
//   - Binary name "code-sign" detection: if os.Args[0] basename is "code-sign"
//     or ends with "/code-sign", enters code-sign mode directly (lines 24-30)
//
// Binary: 0xbb95c0 - main.main
package main
...
// Version is set via -ldflags "-X main.Version=staging-68f0dff496"
var Version = "dev"
