...
| **ESO-mirroring a live access token into the agent** | Ruled out for new work | This is what `google-access-token-eso.yaml` does today for `haku-sandbox`. It is the exposure the proxy design exists to remove.                                                                                                                                                                                                                       |
