...
- [Workload authentication and credential propagation](authentication_and_credentials.md) — authoritative shared workload-token and generic dynamic-substitution design gate
