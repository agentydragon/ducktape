...
flowchart TB
    ...
    SBPOLICY["Planned behavior<br/>app-written Sandbox bindings<br/>and read-only policy view"]:::future
...
it serves both Sandbox types and caller ServiceAccounts without waiting for this broader profile.
