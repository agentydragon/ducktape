...
link:../action_service/README.md[Action Service] owns production composition; fixture executors remain
...
link:../action_service/README.md[the Action Service]). Before this change, the only
...
has not yet been invoked. See link:../action_service/README.md#cancellation[the cancellation API].
...
| `executor_lost` | The lease lapsed and the owning executor's own health heartbeat is also stale.
|===
