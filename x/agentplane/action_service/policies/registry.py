...
from x.agentplane.action_service.policies import argument_schema, exact_actions
from x.agentplane.action_service.policies.kind import Matched, NotMatched

Policy = Annotated[exact_actions.ExactActions | argument_schema.ArgumentSchema, Field(discriminator="type")]


def evaluate(policy: Policy, action: ActionIdentity, arguments: Mapping[str, JsonValue]) -> Matched | NotMatched:
