...
it.each([
  ...
  [{ detail: { code: "link_failed", message: "GitHub authorization is unavailable" } }, "GitHub authorization is unavailable"],
  ...
  [{ detail: [{ loc: ["body", "scopes", 0], msg: "Input should be a valid string" }] }, "body.scopes.0: Input should be a valid string"],
