...
class RunnerBridge:
    ...
    async def _deliver_pending_inputs(
        ...
        allowed to attach and deliver for this Sandbox.  We intentionally retain an unreceived
        command in PostgreSQL after every transport attempt: the runner command id makes retry
        safe, and its event receipt is the authoritative delivery observation.
        """
