...
revision = "0005_thread_command_outbox"
...
def upgrade() -> None:
    ...
    # An existing Thread already names its static Sandbox; only its Kubernetes UID is new.
...
def downgrade() -> None:
    raise RuntimeError("0005_thread_command_outbox cannot be downgraded without discarding durable command intent")
