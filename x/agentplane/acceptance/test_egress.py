...
# (cluster/k8s/agentplane-staging/agentplane-services.k8s.yaml, EgressPolicy "github-public").
...
# (cluster/k8s/agentplane-staging/agentplane-services.k8s.yaml, EgressPolicy "basic"). It holds
...
async def test_the_model_call_itself_goes_through_the_proxy(
    ...
    assert served.policy == BASIC_POLICY, f"the model call was admitted by another policy: {served!r}"
