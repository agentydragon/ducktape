...
from x.agent_server.persist.types import AgentMetadata, AgentRow, ApprovalOutcome, Persistence, PolicyProposal
from x.agent_server.runtime.auto_attach import filter_persistable_servers
...
CREATE TABLE IF NOT EXISTS chat_last_read (
  ...
  PRIMARY KEY (agent_id, server_name)
    ...
    async def get_agent(self, agent_id: AgentID) -> AgentRow | None:
        async with self.open_row() as db:
            db.row_factory = aiosqlite.Row
