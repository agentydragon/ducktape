...
from x.agent_server.policies.policy_types import PolicyRequest, PolicyResponse
from x.agent_server.policy_eval.constants import ENV_POLICY_INPUT, ENV_POLICY_SRC
...
async def run_policy_source(
    *,
    ...
    config: JSONObject = {
        "Image": img,
        "Entrypoint": ["/x/agent_server/policy_eval/shim_bin"],
        "Cmd": [],
        "AttachStdout": True,
        "AttachStderr": True,
        "Tty": False,
        ...
        "HostConfig": {
            ...
            # (aspect py_binary launcher creates /x/agent_server/policy_eval/_shim_bin.venv)
