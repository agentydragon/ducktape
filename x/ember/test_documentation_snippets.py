...
def test_python_session_demo_scripts_are_embedded_and_work(
    ...
    demo_relative = "examples/python_session/demo.sh"
    test_relative = "examples/python_session/test_demo.sh"
    ...
    monkeypatch.setattr(
        "x.ember.matrix_client.MatrixClient.from_projected_secrets", lambda options=None: FakeMatrixClient()
    )
