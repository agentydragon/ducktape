...
// App-wide CSS (classes like .btn, .deco-corners, .display-font). Exported
// so the visual-test harness can style standalone components identically.
export function CasinoStyles() {
  return (
    <style>{`
...
export default function StudyCasino() {
  ...
  return (
    ...
    >
      ...
      {!offline && <ChangelogModal entries={changelogUnacked} onAck={ackChangelog} />}
