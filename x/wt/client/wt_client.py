...
from x.wt.shared.error_handling import validate_worktree_name
...
class WtClient:
    ...
    async def _start_daemon_background(self) -> None:
        ...
        Implementation: create a pipe, launch x.wt.server.wt_server via subprocess.Popen,
        ...
        try:
            ...
            subprocess.Popen(  # noqa: ASYNC220
                [sys.executable, "-m", "x.wt.server.wt_server"],
                env=env,
                stdout=stdout_dest,
                stderr=stderr_dest,
