...
from x.wt.client.cd_utils import emit_cd_command
from x.wt.client.handlers import (
...
from x.wt.client.wt_client import WtClient
from x.wt.shared.configuration import Configuration, load_config
from x.wt.shared.constants import COMMAND_DESCRIPTIONS, MAIN_REPO_ALIASES
...
async def cmd_sh(ctx: typer.Context):
    ...
    All wt commands go through the shell wrapper which calls 'python -m x.wt.cli sh <args>'.
