...
from x.wt.shared.error_handling import GitHubUnavailableError, handle_github_errors
from x.wt.shared.github_models import GitHubPRResponse, HasBasicPR, PRState, PullRequestList
...
def get_github_token(token_arg: str | None = None, *, timeout_secs: float = 10.0) -> str | None:
    ...
    Separated for easy mocking in tests: patch x.wt.server.github_client.get_github_token.
