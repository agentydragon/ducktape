...
from x.sysrw.anthropic.types import Message as AnthropicMessage, MessageRole as AnthropicMessageRole
from x.sysrw.constants import TOOLS_HEADER
from x.sysrw.openai_typing import (
    MessageRole,
...
from x.sysrw.prompts import build_grader_prompt
from x.sysrw.schemas import (
    CCRSample,
...
from x.sysrw.templates.loader import validate_template_file
from x.sysrw.translation import anthropic_messages_to_standard, anthropic_to_chat_messages
...
# Paths
REWRITE_APPLY = resources.files("x.sysrw").joinpath("js/system_rewrite_apply.js")
