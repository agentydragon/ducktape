...
class ToolResponse(CamelCaseModel):
    ...
    user_modified: bool = Field(
        default=False, description="Tracks if file was externally modified after tool execution."
    )
    replace_all: bool = Field(default=False, description="Whether all occurrences were replaced (for Edit operations).")
