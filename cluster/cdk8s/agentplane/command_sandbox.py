...
and its toolchain. staging.py offers both to the sandbox Actions, and each template describes itself
to an agent choosing one in the annotation those Actions read.
"""
