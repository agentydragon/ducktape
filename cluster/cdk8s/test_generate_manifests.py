...
_GENERATED_FILES = (
    ...
    "cluster/k8s/seaweedfs/public-s3/kustomization.yaml",
    ...
    "cluster/k8s/seaweedfs/operator/kustomization.yaml",
    "cluster/k8s/seaweedfs/pr-visuals-bucket/pr-visuals-bucket.k8s.yaml",
    "cluster/k8s/seaweedfs/pr-visuals-bucket/kustomization.yaml",
    ...
    "cluster/k8s/seaweedfs/drivefs-artifacts-bucket/kustomization.yaml",
