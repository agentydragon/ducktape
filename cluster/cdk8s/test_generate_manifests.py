...
_GENERATED_FILES = (
    ...
    "cluster/k8s/agentplane-testing/actions/agentplane-actions.k8s.yaml",
    "cluster/k8s/agentplane-testing/actions/kustomization.yaml",
    "cluster/k8s/agentplane-staging/actions/agentplane-actions.k8s.yaml",
    "cluster/k8s/agentplane-staging/actions/kustomization.yaml",
    "cluster/k8s/agentplane-testing/app/agentplane-app.k8s.yaml",
    "cluster/k8s/agentplane-testing/app/kustomization.yaml",
    "cluster/k8s/agentplane-staging/app/agentplane-app.k8s.yaml",
    "cluster/k8s/agentplane-staging/app/kustomization.yaml",
    ...
    "cluster/k8s/agentplane-testing/db/agentplane-db.k8s.yaml",
    "cluster/k8s/agentplane-staging/db/agentplane-db.k8s.yaml",
    "cluster/k8s/agentplane-testing/llm-ingress/agentplane-llm-ingress.k8s.yaml",
    "cluster/k8s/agentplane-testing/llm-ingress/kustomization.yaml",
    "cluster/k8s/agentplane-staging/llm-ingress/agentplane-llm-ingress.k8s.yaml",
    "cluster/k8s/agentplane-staging/llm-ingress/kustomization.yaml",
    "cluster/k8s/agentplane-testing/egress/agentplane-egress.k8s.yaml",
    "cluster/k8s/agentplane-testing/egress/kustomization.yaml",
    "cluster/k8s/agentplane-staging/egress/agentplane-egress.k8s.yaml",
    "cluster/k8s/agentplane-staging/egress/kustomization.yaml",
    "cluster/k8s/agentplane-testing/dex/agentplane-testing-dex.k8s.yaml",
    "cluster/k8s/agentplane-testing/dex/kustomization.yaml",
