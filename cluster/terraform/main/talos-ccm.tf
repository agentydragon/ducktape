...
# generated/talos-cloud-controller-manager/helmrelease.k8s.yaml (generated by
# cluster/cdk8s/talos_cloud_controller_manager.py). Tofu parses that file directly so
...
locals {
  talos_ccm_helmrelease = yamldecode(
    file("${path.module}/../../generated/talos-cloud-controller-manager/helmrelease.k8s.yaml")
  )
