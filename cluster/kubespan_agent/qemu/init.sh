...
if [ -z "$MODE" ]; then
  echo "QEMU_TEST: ERROR no mode= on kernel cmdline"
...
case "$MODE" in
  ...
  # ═════════════════════════════════════════════════════════════════════════════
  # nft_smoke: run testprobe nft-smoke at specified levels
  # ═════════════════════════════════════════════════════════════════════════════
  nft_smoke)
    if [ -z "$LEVELS" ]; then
  ...
  # ═════════════════════════════════════════════════════════════════════════════
  # kubespan: configure networking, run kubespand, verify tunnel connectivity
  # ═════════════════════════════════════════════════════════════════════════════
  kubespan)
...
YAML
  ...
  # ═════════════════════════════════════════════════════════════════════════════
  *)
    echo "QEMU_TEST: ERROR unknown mode=$MODE (expected nft_smoke or kubespan)"
    echo "o" >/proc/sysrq-trigger
    exit 1
    ;;
