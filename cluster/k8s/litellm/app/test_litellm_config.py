...
# The ConfigMap that mounts proxy-config.yaml as litellm-config is now generated by
# cdk8s (cluster/litellm_constructs.py) rather than kustomize's configMapGenerator;
# //cluster:test_generate_manifests proves litellm.k8s.yaml's embedded config matches
# main_proxy_config(), which cluster/test_generate_manifests.py separately pins to
# this file.
