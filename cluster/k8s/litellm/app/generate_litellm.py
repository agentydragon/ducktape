...
def generate() -> str:
    ...
    # not repeated here.
    # TODO: Re-enable Langfuse integration when langfuse kustomizations are unsuspended
    # (suspended 2026-03-31, see cluster/docs/plan.md). Needs: success_callback: [langfuse],
    # LANGFUSE_HOST env var, and langfuse-api-keys envFrom in the Deployment.
    proxy_config = {"model_list": model_list, "litellm_settings": {"drop_params": True}}
