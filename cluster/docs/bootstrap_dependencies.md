...
| **Financial**   | `agents/coinbase-read/coinbase-api-credentials.sops.yaml`, `agents/openclaw/sandbox-secrets/ibkr-flex-query-credentials.sops.yaml`                                                                          | Coinbase / IBKR portals           |
