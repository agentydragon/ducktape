...
| **OpenAI**      | `props/secrets/openai-api-key.sops.yaml`                                                                                                                                                                    | OpenAI API keys                   |
| **Anthropic**   | —                                                                                                                                                                                                           | Anthropic console                 |
| **Google**      | `agents/airlock/google-client-credentials.sops.yaml`                                                                                                                                                        | Google Cloud console              |
| **Financial**   | `agents/coinbase-read/coinbase-api-credentials.sops.yaml`                                                                                                                                                   | Coinbase / IBKR portals           |
| **Messaging**   | `flux-webhook/ntfy-webhook.sops.yaml`                                                                                                                                                                       | Telegram @BotFather / ntfy.sh     |
| **Home infra**  | `scanner/samba-credentials.sops.yaml`                                                                                                                                                                       | Samba config                      |
| **OAuth**       | `agents/airlock/oura-client-credentials.sops.yaml`                                                                                                                                                          | Oura developer portal             |
| **Device sync** | `activitywatch/syncthing-identity.yaml`, `activitywatch/syncthing-key.sops.yaml`                                                                                                                            | Generated Syncthing identity      |
