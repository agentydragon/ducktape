...
| DeepSeek-V4-Flash (offload)  | llama.cpp master | IQ2_XXS GGUF (2.06 bpw)      | 1M `ext`      | — (E9 wip)          | ~1.1 (CPU) `local` | — (CPU-only) `local` | SWE 79.0 `ext`          | untested (E9 wip)                  | [E9](runs/2026-07-18_e9_deepseek_v4_flash_llamacpp/README.md) |
