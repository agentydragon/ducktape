...
from finance.augur.model.series import CryptoKey, HomeValueKey, InflationKey, RentKey, SP500Key
...
def test_roles_keep_each_series_in_its_own_group() -> None:
    ...
    assert roles.asset_prices.by_asset_price_key() == {SP500Key(): 2, CryptoKey(symbol="btc"): 3}
...
def test_extra_forbid_rejects_flat_kind_at_roles_top_level() -> None:
    ...
    with pytest.raises(ValidationError):
        LevelSeriesGroups[int].model_validate({"sp500": 2})
