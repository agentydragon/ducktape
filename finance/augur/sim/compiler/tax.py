...
# carries forward. A quantum count rather than a Decimal because that is the form both engines
# net in — the JAX reducer clamps against it directly, and it crosses to Rust as `TaxRules`.
