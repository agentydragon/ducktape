...
class TargetAllocationCompileOutput:
    ...
    # Quanta per unit for each sleeve's asset. Emitted per SLEEVE rather than read off the
    # sleeve's lots, because a sleeve the agent holds none of has no lots to read — and that
    # sleeve is exactly the one a target allocation exists to buy into.
