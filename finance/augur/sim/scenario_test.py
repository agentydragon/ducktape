        ...
        Scenario(
            ...
            target_allocation_policies=[
                TargetAllocationPolicy(
                    ...
                    agent_id="alice",
                    account_id="checking",
                    sleeves=[SecuritySleeveTarget(asset=SecurityKey(symbol=SecuritySymbol("vti")), weight=1)],
                    cash_ceiling=0,
                ),
                TargetAllocationPolicy(
                    allow_purchases=False,
                    ...
                    agent_id="alice",
                    account_id="checking",
                    sleeves=[SecuritySleeveTarget(asset=SecurityKey(symbol=SecuritySymbol("qqq")), weight=1)],
                    cash_ceiling=0,
                ),
            ],
            tax_profiles=[],
