...
def build_actor_view(
    *,
    ...
    lot_quantity: jnp.ndarray,
    lot_cost_basis_per_unit_cents: jnp.ndarray,
    lot_unit_price_cents: jnp.ndarray,
    ...
    implementation. `lot_unit_price_cents` must already be this month's marks.
    """
    ...
    scale = lot_quantity_scale[lot_rows][:, None]
    return ActorView(
        month=month,
        cash_cents=cash_cents[cash_rows],
        lot_quantity=quantity,
        lot_value_cents=quantity * lot_unit_price_cents[lot_rows] // scale,
