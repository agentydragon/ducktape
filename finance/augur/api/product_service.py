...
def build_product_service(
    config: Config, models: dict[str, Sampler], *, catalog: CatalogResponse | None = None
) -> ProductService:
    ...
    return ProductService(
        ...
        tlh_portfolios=tuple(managed.spec for managed in resolved_portfolio.tlh_portfolios),
