...
@pytest.fixture
def feature_rich_failure(tmp_path: Path) -> dict[str, Any]:
    ...
    fixture["scenario"]["obligations"].append(
        {
            ...
            "from": account_ref("cashflow", "checking"),
...
def test_rust_and_jax_match_product_metrics_across_a_rollout_failure(feature_rich_failure) -> None:
...
def test_a_frozen_rollout_reports_its_property_value_as_net_worth(feature_rich_failure) -> None:
