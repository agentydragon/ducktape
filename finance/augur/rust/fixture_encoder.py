...
from finance.augur.sim.compiler.tax import MAX_CAPITAL_LOSS_ORDINARY_OFFSET_QUANTA, OPEN_ENDED_BRACKET_UPPER_QUANTA
        ...
        rules_by_profile[profile_index].append(
            {
                ...
                "max_capital_loss_ordinary_offset": MAX_CAPITAL_LOSS_ORDINARY_OFFSET_QUANTA,
            ...
            "scheduled_transfers": [
                {
                    ...
                    "from": _account(transfer.from_agent_id, transfer.from_account_id),
                    "to": _account(transfer.to_agent_id, transfer.to_account_id),
                    "amount": _amount(
                        transfer.amount, quantum=quantum, context=f"scheduled transfer {transfer.cause_id!r}"
                    ),
                    "income_category": _income_category(
                        transfer.income_category, context=f"scheduled transfer {transfer.cause_id!r}"
                    ),
            ...
            "recurring_transfers": [
                {
                    ...
                    "income_category": _income_category(
                        transfer.income_category, context=f"recurring transfer {transfer.cause_id!r}"
                    ),
                    "deduction_category": transfer.deduction_category,
                }
            ...
            "scheduled_property_cashflows": [
                {
                    ...
                    "from": _account(cashflow.from_agent_id, cashflow.from_account_id),
                    "to": _account(cashflow.to_agent_id, cashflow.to_account_id),
                    "amount": _amount(
                        cashflow.amount, quantum=quantum, context=f"scheduled property cashflow {cashflow.cause_id!r}"
                    ),
                    "income_category": _income_category(
                        cashflow.income_category, context=f"scheduled property cashflow {cashflow.cause_id!r}"
                    ),
            ...
            "recurring_property_cashflows": [
                {
                    ...
                    "income_category": _income_category(
                        cashflow.income_category, context=f"recurring property cashflow {cashflow.cause_id!r}"
                    ),
                    "deduction_category": cashflow.deduction_category,
                }
