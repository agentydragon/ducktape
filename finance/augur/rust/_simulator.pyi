...
class _NativeSession:
    ...
    def apply_component(self, rollout_id: int, cause_id: str, effects: ComponentEffects, action: Action | None = None, *, operation: Literal["modeled_realization", "redemption"] = "modeled_realization") -> Receipt | None: ...
    ...
    def account_balance(self, rollout_id: int, agent_id: str, account_id: str) -> int | None: ...
