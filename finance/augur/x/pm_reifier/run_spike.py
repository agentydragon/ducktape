...
Question: can an LLM act as the base measure Q when reifying PM marginals into trajectories —
i.e. emit a diverse cloud of trajectories *in augur's native shape* whose marginals,
