...
The [Guyton–Klinger source contract](../study/guyton_klinger/README.md) distinguishes
...
choices. The [implementation plan](../study/guyton_klinger/PLAN.md) sketches a shell using the
