...
| [Pfau–Kitces rising glide paths (2014)](https://www.financialplanningassociation.org/article/journal/JAN14-reducing-retirement-risk-rising-equity-glide-path)                       | Compare static, rising and falling allocation on shared paths, with the chosen rebalance convention.                                                                              | Existing allocation callbacks; GS pins study conventions. POL only for joint/stateful rules; EXIT for zero-target arms. Report shortfall severity as well as frequency. |
