...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| General execution reports through product-named, fixed wealth metrics (`sim/backend.py`, `rust/product.rs`); compact failure metadata does not identify the unpaid component or contract. | Domain-owned outcomes with compact cause/receipt identity; UI projections are consumers.                                                                         | OUT                 |
...
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OUT    | Identify spending shortfall versus unpaid contract/tax demand in compact outcomes, without inferring legal default from an internal cash-demand type. Clarify product-named wealth output ownership and experiment reporting CPI/base date.                                                                                               | Compact cause/receipt identity reconciles to forensic evidence. Preserve actual stop books, observed-only monthly fans, completed-horizon wealth, recorded-through-stop shortfall and policy-component requested/paid receipt parity. No recovery or partial settlement.                                                     |
