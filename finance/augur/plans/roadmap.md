...
| `fit/metrics.py::_summarise_scores` reports an IID-style standard error across potentially overlapping origins; separate holdout code avoids that claim.                                      | One explicit comparison/uncertainty convention, preserving per-origin data and model limitations.                                                                | SCORE               |
...
| SCORE  | Reuse existing fitting/scoring and macro-window experiments in an author-wired comparison shell; repair uncertainty reporting separately.                                                                                                                                                                                                                                        | Same observables, units, transformations, origins and held-out periods; explicit release/revised vintage; marginal and joint/path diagnostics; dependence-aware uncertainty or an explicit refusal to rank. No invented Gaussian density for a sample-only model.                                                                                                                              |
