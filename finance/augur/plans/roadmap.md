...
Grounded at `devel` `de89676175` (2026-09-09). The
...
**Deliberate non-edges:** P4X, P6 and P7M are independent migration roots.
P6 consumes existing retained-state stepping and the existing-spending control,
not GP, P4X, P7–P8, OUT, CAP or new tax coverage. P7's first scoped timing
...
books stay in Rust. The sole policy callable accepts and returns batches. P6/GL
...
1. Dispatch **P4X, P6 and P7M** in parallel; P6 uses already-landed stepping
