...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| General execution reports through product-named, fixed wealth metrics with zero-filled post-failure wealth (`sim/backend.py`, `rust/product.rs`).                | Explicit stop/default outcomes reconcile to events; stopped books are not reported as actual zero terminal wealth, and UI projections are consumers.             | OUT                 |
| Native spending/allocation callbacks cannot be composed jointly; zero-target arithmetic and receipt-aware policy state are unsupported.                          | Joint decisions and meaningful transitions use canonical execution; support zero targets/full exits without invalid arithmetic.                                  | POL                 |
...
| ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OUT    | Distinguish spending shortfall, contract default and stopped paths in results; remove zero-filled post-failure wealth being interpreted as actual terminal books. Clarify product-named wealth output ownership.                                                                                                                          | Matching compact/forensic failure cause, including failure with a remaining house/debt. Censored terminal outcomes and reporting CPI/base date are explicit. Preserve the policy component's existing requested/paid receipt parity and observed-month boundary. This does not add recovery or partial settlement.           |
| BIND   | Separate slices: distinguish total-return proxies from distributing products and validate held/purchasable support; supply equity price-return **and dividend-amount paths**, with explicit historical/fitted payout assumptions. Reconcile remaining `typed_series_config.md` work here; do not redo typed keys already present.         | Missing payouts, incompatible tax character and double-counted total returns reject. Price plus payouts reconcile to total return before tax, with explicit payout timing and evidence/model provenance. No global registry or universal fitter.                                                                             |
| POL    | After the remaining GP choices, compose coordinated budget/allocation and receipt-aware policy state. Separately support zero-target/full-exit allocation arithmetic and compact native allocation capture.                                                                                                                               | Joint decisions preserve causal observations and isolated state. Record meaningful transitions and link settlement receipts, not closure internals. Zero-target sales/deposits/rebalancing reconcile under integer rounding. Compact allocation output matches forensic execution.                                           |
...
| ----------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| GP — what can a decision see/do?                                  | For coordinated budget/allocation, settle known contract/tax visibility, request/receipt distinction and state updates after rejection. The existing separate callbacks review at opening and use all-or-none settlement. Changing priorities, partial payment or recovery requires a separate explicit decision.                                                                                                                            | OUT can measure current semantics honestly; no world-model redesign is needed. A non-mutating funding/tax preview is added only when a consumer needs it.                                                                           |
...
1. Run **GP**, **GT**, and **GS** as bounded decisions alongside the remaining OUT work;
   define joint-policy semantics and TAX's acceptance cases from the answers.
   Define BIND's remaining product validation and equity-payout cases against the
   existing historical/structural consumers, not a speculative universal market interface.
2. Start **SCORE** independently, reusing the already runnable holdout work.
