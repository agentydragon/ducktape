...
| Tax surface is narrower than the chosen scope: missing NIIT/qualified-dividend support; no effective-year schedule in `Jurisdiction`; no opening year-to-date facts. | Declared supported-case matrix, dated rules and opening tax state; unsupported relevant cases reject. Existing loss netting/carryforward is not reimplemented.   | GT, TAX      |
