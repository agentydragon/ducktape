...
authority as counterparty actors, and a World composed from declared facts with
`compile_run` as an import adapter. Remaining: untracked domains absent from
results.
