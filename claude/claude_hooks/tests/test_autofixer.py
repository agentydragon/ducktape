...
class TestPreCommitAutoFixerHook:
    def test_disabled_hook(self, autofixer_hook, integration_env):
    ...
    def test_no_file_path(self, autofixer_hook, integration_env):
    ...
    def test_get_precommit_root_success(self, autofixer_hook, unit_env):
        repo_root = autofixer_hook._get_precommit_root(unit_env.repo_path)
        assert repo_root == unit_env.repo_path

    def test_run_precommit_success_with_changes(self, autofixer_hook, integration_env):
    ...
    def test_run_precommit_no_changes_real(self, autofixer_hook, unit_env):
    ...
    def test_dry_run_mode(self, unit_env):
    ...
    def test_execute_success_with_changes(self, autofixer_hook, integration_env):
