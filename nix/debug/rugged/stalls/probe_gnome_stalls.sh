...
usage() {
  cat >&2 <<'EOF'
Usage: nix/debug/rugged/stalls/probe_gnome_stalls.sh [options]
...
Options:
  ...
  --out-dir DIR        Output directory, default: nix/debug/rugged/stalls/captures
...
gcore=1
perf_seconds=10
out_dir="nix/debug/rugged/stalls/captures"
out=""
mark_file=""
...
if [[ -z "${DBUS_SESSION_BUS_ADDRESS:-}" ]]; then
  ...
  echo "  sudo -E nix/debug/rugged/stalls/probe_gnome_stalls.sh ..." >&2
  exit 1
fi
